/**
 * Torii version: 0.2.2
 * Built: Fri Oct 24 2014 17:07:07 GMT+0200 (CEST)
 */
(function() {
...
define("torii/providers/oauth2-bearer", 
  ...
  function(__dependency1__, __dependency2__, __dependency3__, __dependency4__, __exports__) {
    ...
    var Oauth2Bearer = Provider.extend({
      ...
      /**
       * The oauth response type we expect from the third party provider. Hardcoded to 'token' for oauth2-bearer flows
      ...
      */
       ...
       *   - authorizationData: The authorization response object from the 3rd-party provider
